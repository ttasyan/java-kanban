...
public class InMemoryTaskManagerTest {
    ...
    public void addEpicTest() {
        Epic epic = new Epic("tasks.Epic 1", "epic description");
    ...
    public void addSubTaskTest() {
        SubTask subTask = new SubTask("tasks.SubTask 1", "Subtask description", 2);
    ...
    public void addTasksAndFindById() {
        Epic epic = new Epic("tasks.Epic 1", "Description");
    ...
    public void subtaskRemovalTest() {
        InMemoryTaskManager taskManager = new InMemoryTaskManager();
        Epic epic = new Epic("tasks.Epic 1", "Description 1");
